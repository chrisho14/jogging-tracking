  ...
  render() {
    ...
    return (
      <Container fluid>
        ...
        <Header as="h2" content={user.get('_id') ? 'Edit User' : 'New User'} color="teal" />
        <Form onSubmit={this.onSubmit}>
          <Segment>
            <Header as="h4" content="Basic Info" dividing color="teal" />
            <Form.Input label="Username" required value={user.get('userName') || ''} onChange={this.onUpdateField('lastName')} />
